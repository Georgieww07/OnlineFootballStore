    ...
    public void createAppProducts() {
        ...
        if(productRepository.count() == 0) {
            List<Product> products = List.of(
                    ...
                    Product.builder().name("Adidas Brazuca").description("Premium Adidas collection").price(new BigDecimal("309.99")).category(Category.BALLS).imageUrl("https://res.cloudinary.com/confirmed-web/image/upload/c_lfill,w_500,h_600/v1710403028/adidas-group/I3S/stories/images/adidas-world-cup-football-history-archive-gameplana-2014Brazuca-1440x9999_pb8sch.jpg").brand(Brand.ADIDAS).isInStock(true).deleted(false).build(),
